...
import 'package:task_2/pages/item.dart';
...
import 'package:task_2/pages/promoa.dart';
            ...
            Consumer<ThemeProvider>(
              builder: (context, themeProvider, child) {
                return Switch(
                  ...
                  inactiveThumbColor: Color.fromARGB(255, 11, 0, 0),
                );
              },
            ),
          ]
         ...
         child: Column(
          ...
          SingleChildScrollView(
           ...
           Padding(
            ...
            Padding(
              padding: EdgeInsets.only(left: 8.0,right: 8,bottom:6),
